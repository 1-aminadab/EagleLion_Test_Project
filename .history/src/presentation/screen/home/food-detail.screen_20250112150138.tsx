      ...
      >
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.deliveryToggle}>
            <TouchableOpacity onPress={() => setCurrentButton()} style={[currentButton === ButtonType.Delivery ?styles.toggleButtonActive : styles.toggleButton]}>
              <Text style={styles.toggleButtonTextActive}>Delivery</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[currentButton === ButtonType.Takeaway ? styles.toggleButtonActive : styles.toggleButton]}>
