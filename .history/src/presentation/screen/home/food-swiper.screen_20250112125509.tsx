    ...
    <View style={styles.container} onLayout={(e) => setHeight(e.nativeEvent.layout.height)}>
      ...
      <View style={styles.header}>
        ...
        <View style={{position:"relative"}}>
          {
            totalCartItems > 0   && <Typography size={FontSizes.ExtraSmall} style={{zIndex:1,position:"absolute", fontSize:7, left:"72%",top:"-10%", height:15, width:15, alignItems:"center", borderRadius:10, backgroundColor:"white"}}>
{
  totalCartItems
}
            </Typography>
