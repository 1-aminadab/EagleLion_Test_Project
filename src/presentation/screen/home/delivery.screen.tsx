            ...
            <SwipableModal visible={isModalVisible} onClose={() => setModalVisible(false)}>
                <View >
                    ...
                    <View style={{ borderRadius: 15, overflow: 'hidden' }} >
                        {/* Promo Banner */}
                        <ImageBackground source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbelSl1E10lHSOuAWSK0mYCw7DDGmnR8v3ZA&s' }} style={styles.promoBanner}>



                            <Typography size={FontSizes.Large} weight={FontWeights.Bold}>
                                Beauty Redefined
                            </Typography>
                            <Typography size={FontSizes.Regular} color={Colors.TextSecondary}>
                                Snoobeauty
                            </Typography>
