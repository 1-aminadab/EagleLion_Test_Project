    ...
    <View style={styles.container} onLayout={(e) => setHeight(e.nativeEvent.layout.height)}>
      ...
      <View style={styles.header}>
        ...
        <View style={{position:"relative"}}>
            ...
            <Typography size={FontSizes.ExtraSmall} style={{zIndex:1,position:"absolute", fontSize:7, left:"80%",top:"0%", height:10, width:10, alignItems:"center",justifyContent:"center", borderRadius:10, backgroundColor:"white"}}>
{
  totalCartItems
}
            </Typography>
