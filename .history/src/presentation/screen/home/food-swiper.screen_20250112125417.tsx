        ...
        <View style={{position:"relative"}}>
          {
            ...
            <Typography size={FontSizes.ExtraSmall} style={{zIndex:1,position:"absolute", fontSize:7, left:"72%",top:"-10%", height:15, width:15, alignItems:"center",justifyContent:"center", borderRadius:10, backgroundColor:"white"}}>
{
  totalCartItems
}
            </Typography>
