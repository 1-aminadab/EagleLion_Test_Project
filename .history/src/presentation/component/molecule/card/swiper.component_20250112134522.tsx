...
const ContinuousScrollBannerReanimated:React.FC<{data:{id:string, label:string, image:string}[]}> = ({data})  =>  {
    const firstItem = data[0];
    const lastItem = data[data.length - 1];
    data.push({ id: '-1', label: firstItem.label, image:firstItem.image }); // Add first item at last
    data.unshift({ id: '-2', label: lastItem.label, image:lastItem.image}); // Add last item at first
...
default export  ContinuousScrollBannerReanimated