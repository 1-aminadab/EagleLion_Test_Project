  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Icon  from={IconLibraryName.Ionicons} name="close" size={24} color={Theme.colors.black} onPress={() => navi} />
        <Text style={styles.headerTitle}>Cart</Text>
        <TouchableOpacity>
          <Icon from={IconLibraryName.MaterialCommunityIcons} name="delete-outline" size={27} color={Theme.colors.black} onPress={() => navi} />
        </TouchableOpacity>
      </View>
