            ...
            <TouchableOpacity onLongPress={() => handleSelectFood(item.id)} style={[styles.item, { height: viewHeight }]}>
              <ImageBackground style={styles.img} source={{ uri: item.imageUrl }} resizeMode="cover">
                ...
                <View style={styles.card}>
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate(HomeScreens.det)} style={{ backgroundColor: Theme.colors.GrayDark + 'ee', flexDirection: 'row', alignItems: 'center', padding: 10, borderRadius: 15 }}>
                    <View style={{ flex: 1 }}>
